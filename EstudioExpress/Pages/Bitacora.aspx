            ...
            <ContentTemplate>
                <div>
                    ...
                    <div style="display: inline-block; margin-right: 20px; margin-bottom: 5px">
                        ...
                        <div>
                            <asp:DropDownList ID="criticidadDropDownList" runat="server" Width="173px" Height="35px">
                            </asp:DropDownList>
                        </div>
                    </div>
                    <div style="display: inline-block; margin-right: 20px; margin-bottom: 5px">
                        <span>Usuario</span>
                        <div>
                            <asp:DropDownList ID="usuarioDropDownList" runat="server" Width="172px" Height="35px">
                            </asp:DropDownList>
                ...
                <div>
                    <div style="display: inline-block;">
                        <asp:Calendar ID="desdeCalendar" Style="font-size: small;" runat="server" OnSelectionChanged="desdeCalendar_SelectionChanged"></asp:Calendar>
                    </div>
                    <div style="display: inline-block;">
