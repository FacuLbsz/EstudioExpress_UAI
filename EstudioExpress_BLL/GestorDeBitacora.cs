...
public class GestorDeBitacora
{
    ...
    {
        DataTable dataTable = baseDeDatos.ConsultarBase(SetFormatDate + " Select * from Bitacora " + CrearWhere(criticidad, idUsuario, fechaDesde, fechaHasta) +  " ORDER BY fecha DESC");
